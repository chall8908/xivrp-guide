/*
 * String transliteration for URI (slug) generation purposes.
...
export default function toUri(str) {
  ...
  // Determine the correct transliteration of и
